...
namespace Codecool.CodecoolShop
{
    public class Startup
    {
        ...
        private void SetupInMemoryDatabases()
        {
            ...
            productDataStore.Add(new Product { Name = "Amazon Fire", DefaultPrice = 466.9m, Currency = "USD", Description = "Fantastic price. Large content ecosystem. Good parental controls. Helpful technical support.", ProductCategory = tablet, Supplier = amazon });
